...
class BlogTestView(TestCase):
    ...
    def test_article_detail_view(self):
        ...
        # sending request
        res = self.client.get(
            reverse('blog:article_detail', args=(article.id, article.slug)))
        ...
        self.assertEqual(res.data['cover'],
                         f'http://testserver/media/{article.cover}')
    ...
    def test_article_list_view(self):
        ...
        # becuase the cover field in response is differnt to the queryset cover field
        self.assertNotEqual(res.data, sz.data)
