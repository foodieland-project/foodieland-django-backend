...
urlpatterns = [
    ...
    path('comments/<int:pk>/', views.CommentListView.as_view(),
         name="comment-per-recipe"),
    path('comment/create/<int:recipe_id>/',
         views.CommentCreate.as_view(), name="recipe-create-comment"),
    path('comment/update/<int:recipe_id>/<int:comment_id>/',
         views.CommentUpdate.as_view(), name="recipe-update-comment"),
    path('comment/delete/<int:recipe_id>/<int:comment_id>/',
         views.CommentDelete.as_view(), name="recipe-delete-comment"),

    # replies
    path('reply/create/<int:recipe_id>/<int:comment_id>/',
         views.ReplyCreate.as_view(), name="reply-create"),
    path('reply/update/<int:recipe_id>/<int:comment_id>/<int:reply_id>/',
